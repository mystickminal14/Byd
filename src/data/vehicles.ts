...
export const VEHICLES: Vehicle[] = [
  {
    ...
    heroImage: '/assets/home/sealion7.jpg',
    cardImage: '/assets/sealion7/pc-1.jpg',
    cinematicImage: '/assets/sealion7/pc-v2l.jpg',
    interiorImage: '/assets/sealion7/pc-9.jpg',
    accent: '#4f7fd9',
    ...
    story: [
      {
        ...
        image: '/assets/sealion7/pc-2.jpg',
      },
      {
        ...
        image: '/assets/sealion7/pc-9.jpg',
      },
      {
        ...
        image: '/assets/sealion7/pc-6.jpg',
      },
      {
        ...
        image: '/assets/sealion7/pc-v2l.jpg',
      },
    ],
    variants: [{ name: 'Premium RWD 82.56 kWh', price: 7999000 }],
    gallery: [
      { src: '/assets/sealion7/pc-1.jpg', alt: 'SEALION 7 front three-quarter in studio light' },
      { src: '/assets/sealion7/pc-3.jpg', alt: 'SEALION 7 rear with water-drop light strip' },
      { src: '/assets/sealion7/pc-10.jpg', alt: 'Panoramic canopy over the rear cabin' },
      { src: '/assets/sealion7/pc-7.jpg', alt: 'Diamond-quilted sport seats' },
      { src: '/assets/sealion7/pc-4.png', alt: 'Driver cockpit with rotating touchscreen' },
      { src: '/assets/sealion7/pc-11.jpg', alt: 'Dynaudio A-pillar tweeter' },
      { src: '/assets/sealion7/pc-6.jpg', alt: 'Electric tailgate and 500L boot' },
      { src: '/assets/sealion7/pc-v2l.jpg', alt: 'V2L powering a lakeside movie night' },
    ],
    brochures: [
  ...
  },
  {
    ...
    heroImage: '/assets/atto3/1.jpg',
    cardImage: '/assets/home/atto-3-kv.jpg',
    cinematicImage: '/assets/atto3/13.jpg',
    interiorImage: '/assets/atto3/10.jpg',
    accent: '#39c6f2',
    ...
    story: [
      {
        ...
        image: '/assets/atto3/light-resize.jpg',
      },
      {
      ...
      },
      {
        ...
        image: '/assets/atto3/tire-resized.jpg',
      },
      {
        ...
        image: '/assets/atto3/vtl-wide.jpg',
      },
    ],
    variants: [
    ...
    gallery: [
      { src: '/assets/atto3/1.jpg', alt: 'ATTO 3 in the studio' },
      { src: '/assets/atto3/13.jpg', alt: 'ATTO 3 rear three-quarter' },
      { src: '/assets/atto3/10.jpg', alt: 'Rhythm interior and rotating screen' },
      { src: '/assets/atto3/4-3.jpg', alt: 'Door speaker detail' },
      { src: '/assets/atto3/4-4.jpg', alt: 'Wireless phone charging' },
      { src: '/assets/atto3/4-7.jpg', alt: '7 airbags, top view' },
      { src: '/assets/atto3/6.jpg', alt: 'e-Platform 3.0 rolling chassis' },
      { src: '/assets/atto3/7.jpg', alt: 'Blade Battery test rig' },
    ],
    brochures: [
    ...
    adas: [
      {
        ...
        poster: '/assets/atto3/adas/ACC.jpg',
      },
      {
        id: 'aeb',
        label: 'AEB',
        ...
        poster: '/assets/atto3/adas/AEB.jpg',
      },
      {
        id: 'ldw',
        label: 'Lane Keeping',
        ...
        poster: '/assets/atto3/adas/LDW-LDP.jpg',
      },
      {
        id: 'rcta',
        ...
        poster: '/assets/atto3/adas/RCTA-RCTB.jpg',
      },
    ],
  },
  {
    ...
    heroImage: '/assets/atto2/2.jpg',
    cardImage: '/assets/atto2/3.jpg',
    cinematicImage: '/assets/atto2/3.jpg',
    interiorImage: '/assets/atto2/4.jpg',
    accent: '#9db97f',
    ...
    story: [
      ...
      },
      {
        ...
        image: '/assets/atto2/8.jpg',
      },
    ],
    variants: [{ name: 'Premium · 51.13 kWh', price: 4595000 }],
    gallery: [
      { src: '/assets/atto2/2.jpg', alt: 'ATTO 2 at golden hour' },
      { src: '/assets/atto2/3.jpg', alt: 'ATTO 2 on a coastal road' },
      { src: '/assets/atto2/4.jpg', alt: 'Rotating touchscreen cockpit' },
      { src: '/assets/atto2/5.jpg', alt: 'Panoramic roof from the cabin' },
      { src: '/assets/atto2/6.jpg', alt: 'e-Platform 3.0 rolling chassis' },
      { src: '/assets/atto2/7.jpg', alt: 'Blade Battery pack' },
      { src: '/assets/atto2/9.jpg', alt: 'ATTO 2 pair in the city' },
    ],
    brochures: [
  ...
  },
  {
    ...
    heroImage: '/assets/dolphin/2.jpg',
    cardImage: '/assets/dolphin/2.jpg',
    cinematicImage: '/assets/dolphin/1.jpg',
    interiorImage: '/assets/dolphin/3.jpg',
    accent: '#7fb6d9',
    ...
    gallery: [
      { src: '/assets/dolphin/2.jpg', alt: 'DOLPHIN pair on a coastal road' },
      { src: '/assets/dolphin/3.jpg', alt: 'DOLPHIN interior overview' },
      { src: '/assets/dolphin/4.jpg', alt: 'Rotating touchscreen' },
      { src: '/assets/dolphin/5.jpg', alt: 'Vegan leather sport seats' },
      { src: '/assets/dolphin/6.jpg', alt: 'Boot with seats up' },
      { src: '/assets/dolphin/9.jpg', alt: 'Aero wheel detail' },
    ],
    brochures: [
  ...
  },
  {
    ...
    heroImage: '/assets/m6/1.jpg',
    cardImage: '/assets/m6/3.jpg',
    cinematicImage: '/assets/m6/2.jpg',
    interiorImage: '/assets/m6/4.jpg',
    accent: '#c9cdd4',
    ...
    gallery: [
      { src: '/assets/m6/1.jpg', alt: 'M6 studio side profile' },
      { src: '/assets/m6/3.jpg', alt: 'M6 front view' },
      { src: '/assets/m6/4.jpg', alt: 'Brown ergonomic interior' },
      { src: '/assets/m6/6.jpg', alt: 'Rotating smart screen' },
      { src: '/assets/m6/7.jpg', alt: 'Seven-seat boot configuration' },
      { src: '/assets/m6/8.jpg', alt: 'Panoramic skylight' },
    ],
  ...
  },
  {
    ...
    heroImage: '/assets/atto1/2.jpg',
    cardImage: '/assets/atto1/2.jpg',
    cinematicImage: '/assets/atto1/6.jpg',
    interiorImage: '/assets/atto1/4.jpg',
    accent: '#c8e05a',
    ...
    gallery: [
      { src: '/assets/atto1/1.jpg', alt: 'ATTO 1 World Urban Car artwork' },
      { src: '/assets/atto1/2.jpg', alt: 'ATTO 1 front studio' },
      { src: '/assets/atto1/3.jpg', alt: 'ATTO 1 at home in the city' },
      { src: '/assets/atto1/4.jpg', alt: 'e-Platform 3.0 cutaway' },
      { src: '/assets/atto1/5.png', alt: 'Blade Battery pack' },
      { src: '/assets/atto1/6.jpg', alt: 'ATTO 1 pair under the palms' },
    ],
    brochures: [
